...
def main():
    if len(sys.argv) < 3:
        print("Usage: python morph_faces_hold_end.py <image1> <image2>")
        sys.exit(1)
    ...
    if points1 is None or points2 is None:
        ...
        out = cv2.VideoWriter('morph_output_hold_end.mp4', cv2.VideoWriter_fourcc(*'mp4v'), 20.0, (img1.shape[1], img1.shape[0]))
        
        # Add 3 seconds of static image 1
        for _ in range(60):
            out.write(img1)
        ...
        # Add 1 second of static image 2
        for _ in range(20):
            out.write(img2)
            
        out.release()
        print("Saved simple cross-dissolve to morph_output_hold_end.mp4")
        return
    ...
    out = cv2.VideoWriter('morph_output_hold_end.mp4', cv2.VideoWriter_fourcc(*'mp4v'), 20.0, (w, h))
    ...
    out.release()
    print("Saved morph_output_hold_end.mp4")
