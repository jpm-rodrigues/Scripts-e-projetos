...
def main():
    ...
    if points1 is None or points2 is None:
        ...
        out = cv2.VideoWriter('morph_output_static.mp4', cv2.VideoWriter_fourcc(*'mp4v'), 20.0, (img1.shape[1], img1.shape[0]))
        ...
        for alpha in np.linspace(0, 1, 60):
            ...
            out.write(blended)
        out.release()
        print("Saved simple cross-dissolve to morph_output_static.mp4")
        return
    ...
    out = cv2.VideoWriter('morph_output_static.mp4', cv2.VideoWriter_fourcc(*'mp4v'), 20.0, (w, h))
    ...
    out.release()
    print("Saved morph_output_static.mp4")
